...
public class CategoryController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Boolean> deleteCategory(@PathVariable("id") UUID cateforyID) {
        return new ResponseEntity<>(categoryService.deleteCategory(cateforyID),HttpStatus.NO_CONTENT);
    }
