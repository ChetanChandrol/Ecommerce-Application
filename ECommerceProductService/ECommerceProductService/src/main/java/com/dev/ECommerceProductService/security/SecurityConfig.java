    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/product/**", "/search/**").hasAnyAuthority("USER", "ADMIN")
                        // Restrict everything else (POST, DELETE, etc.) and Category to ADMIN
                        .requestMatchers("/category/**", "/product/**").hasAuthority("ADMIN")
